...
We then began exploring alternative subjects and datasets where implementing a RAG system would be both contextually appropriate and capable of delivering meaningful and insightful results. Seeking a highly specific and structured domain, we turned our attention to the field of law, recognizing its potential for meaningful application, and more specifically French jurisprudence. After identifying our dataset, we then divided the project into two main branches:
- Jurisprudence Assistance System
	...
	- We have not tested already the fact-checker part of our model.
- Logic
